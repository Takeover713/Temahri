function user_job_setup()
	...
	state.Weapons:options('Naegling','Agwu','AgwuDW')
	
	autows_list = {['Agwu']='Ruinator',['AgwuDW']='Ruinator'}
...
--sub="Sacro Bulwark", --Divine Interference II

--AF (Beast > Totemic)
 --Legs Not started +4
 --Body +1 > +4 (reward)

--Relic (Monster > Ankusa)
 --Head +4
 --Legs Currently 109 (reward)
 --Feet Currently 109 (reward)

function init_gear_sets()

	-- Weapons sets
	sets.weapons.Agwu = {main="Agwu's Axe",sub="Regis",}
	sets.weapons.Naegling = {main="Naegling"}
	sets.weapons.AgwuDW = {main="Agwu's Axe",sub="Charmer's Merlin",}
	...
	sets.idle.Pet = {
		...
		feet="Gleti's Boots",
		waist="Isa Belt",
		ear1="Odnowa Earring +1", --ear1="Domesticator's Earring" The Savage II
	...
	sets.idle.Pet.Engaged = { --Same set as above
		main="Agwu's Axe",
		sub="Sacro Bulwark",
		ammo="Voluspa Tathlum",
		head="Nuk. Cabasset +3",
	...
	sets.precast.JA.Reward = {
		--main="Mdomo Axe +1", --UNM Kubool Ja's Mhuufya + R15 with Hides
		--sub="Sacro Bulwark", --Divine Interference II
		head="Null Masque", --head="Stout Bonnet" ???
		--neck="Phalaina Locket",  --Bismarck	Bibiki Bay - (F-9), (?-?)	Spawned during a Voidwatch Op. Item appears in a Riftworn Pyxis.
		body="Nyame Mail",
		hands="Malignance Gloves",
		legs="Nukumi Quijotes +3",
		feet="Ankusa Gaiters",
	...
	sets.midcast.Pet.WS = {
		...
		ammo="Voluspa Tathlum",
		head="Nuk. Cabasset +3",
		neck="Adad Amulet", --Locker
		body="Nukumi Gausape +3",
		hands="Nukumi Manoplas +3",
		legs="Nukumi Quijotes +3",
		feet="Gleti's Boots",
		waist="Incarnation Sash", --locker
		--ear1="Kyrene's Earring", --AH
		ear2="Nukumi Earring +1",
		ring1="Tali'ah Ring",
		ring2="C. Palug Ring",
		back="Artio's Mantle",
	...
	sets.midcast.Pet.MagicReady = { --ODY
		main="Agwu's Axe",
		ammo="Hesperiidae",
		head="Nuk. Cabasset +3",
		neck="Adad Amulet", --Locker
		--neck="Bst. Collar +2", 	--AH Not required.
		body="Nukumi Gausape +3",		
		hands="Nukumi Manoplas +3",
		legs="Nukumi Quijotes +3",
		feet="Gleti's Boots",
